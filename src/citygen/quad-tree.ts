...
export class QuadTree<T> {
  ...
  private split(): void {
    ...
    this.nodes = [
      // top-right
      new QuadTree<T>({ x: x + hw, y, width: hw, height: hh, rotation: 0 }, this.maxObjects, this.maxLevels, nextLevel),
      // top-left
      new QuadTree<T>({ x, y, width: hw, height: hh, rotation: 0 }, this.maxObjects, this.maxLevels, nextLevel),
      // bottom-left
      new QuadTree<T>({ x, y: y + hh, width: hw, height: hh, rotation: 0 }, this.maxObjects, this.maxLevels, nextLevel),
      // bottom-right
      new QuadTree<T>({ x: x + hw, y: y + hh, width: hw, height: hh, rotation: 0 }, this.maxObjects, this.maxLevels, nextLevel),
    ];
  }
